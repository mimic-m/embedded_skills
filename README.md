...
```bash
# 例: すべてのスキルをインストール
for skill in ceedling-test-from-diff fff-mock-generation c-code-review-from-diff change-spec-from-diff docx-review-comment-from-diff extract-requirements-documents; do
